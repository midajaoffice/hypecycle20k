# Anleitung — nur für dich

**Nichts hier ins ChatGPT Project.**
...
**Portfolio-Lebenszyklus** (Watchlist raus/rein, Verkauf, Ausführung, `rejected-ideas`): vollständig in [`../chatgpt/operator-protocol.md`](../chatgpt/operator-protocol.md) → Abschnitt *Portfolio-Lebenszyklus*; Kurzfassung in [`../chatgpt/operator-core.md`](../chatgpt/operator-core.md).
